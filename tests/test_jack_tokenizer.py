...
def test_has_more_tokens(create_tokenizer):
    tokenizer = create_tokenizer("let;")
    assert tokenizer.get_current_token().value == "let"
    assert tokenizer.has_more_tokens() is True
    tokenizer.advance()
    assert tokenizer.get_current_token().value == ";"
    assert tokenizer.has_more_tokens() is False
